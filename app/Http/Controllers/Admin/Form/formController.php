...
class formController extends Controller
{
    ...
    public function dynamicForm()
    {
        ...
        return view('admin.form.form', compact(['category']));
    }
    ...
    function showFormData(Request $request, $cat_id = "")
    {
        ...
        ");
            ...
            //     echo "</pre>";
            //     return;
            return view('admin.form.list_form_data', compact(['category', 'result', 'th', 'options']));
        }
    }
    ...
    function customForm()
    {
        ...
        return view('admin.form.custom_form', compact(['category', 'type']));
    }
    ...
    function modifyForm()
    {
        $category = DB::table('category')->where(['parent_id' => null])->get();
        $type = DB::table('tbl_form_tag_type')->get();
        return view('admin.form.modify_custom_form', compact(['category', 'type']));
    }
